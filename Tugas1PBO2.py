...
def insert_data(conn):
   ...
   sql = "INSERT INTO mahasiswaumc (idmhs, nim, nama, idfakultas, idprodi) VALUES (%s, %s, %s, %s, %s)"
   cur = conn.cursor()
   cur.execute(sql, val)
   conn.commit()
   print("==================================")
...
def update_data(conn):
   ...
   sql = "UPDATE mahasiswaumc SET nim=%s, nama=%s, idfakultas=%s, idprodi=%s WHERE idmhs=%s"
